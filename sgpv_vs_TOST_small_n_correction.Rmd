...
```
Let's look at a single study with diverging p-values to see what is going on.
...
#Claculate Width of CI
tt.stat.1[2] - tt.stat.1[1]
#Calculate Width of equivalence range
d.hi - d.lo
#Ratio
(tt.stat.1[2] - tt.stat.1[1]) / (d.hi - d.lo)
