...
If the observed correlation falls exactly on the equivalence bound the *p*-value for the equivalence test is 50%. In correlation test, the *p* value is computed based on a transformed correlation score, computed as follows: 
