...
\hypersetup{unicode=true,
            ...
            pdfkeywords={equivalence testing, second generation p-values, hypothesis testing, TOST, statistical inference},
            pdfborder={0 0 0},
            breaklinks=true}
...
\authornote{All code associated with this article, including the reproducible manuscript, is available from \url{https://github.com/Lakens/TOST_vs_SGPV} and \url{https://osf.io/8crkg/}. The preprint can be found at \url{https://psyarxiv.com/7k6ay/}. This work was supported by the Netherlands Organization for Scientific Research (NWO) VIDI grant 452-17-013.
...
Kruschke, J. K. (2018). Rejecting or Accepting Parameter Values in Bayesian Estimation. \emph{Advances in Methods and Practices in Psychological Science}, \emph{1}(2), 270--280. doi:\href{https://doi.org/10.1177/2515245918771304}{10.1177/2515245918771304}
...
\leavevmode\hypertarget{ref-lakens_equivalence_2018-1}{}%
...
Schuirmann, D. J. (1987). A comparison of the two one-sided tests procedure and the power approach for assessing the equivalence of average bioavailability. \emph{Journal of Pharmacokinetics and Biopharmaceutics}, \emph{15}(6), 657--680. doi:\href{https://doi.org/https://doi.org/10.1007/BF01068419}{https://doi.org/10.1007/BF01068419}

\leavevmode\hypertarget{ref-serlin_rationality_1985}{}%
Serlin, R. C., \& Lapsley, D. K. (1985). Rationality in psychological research: The good-enough principle. \emph{American Psychologist}, \emph{40}(1), 73--83. doi:\href{https://doi.org/http://dx.doi.org/10.1037/0003-066X.40.1.73}{http://dx.doi.org/10.1037/0003-066X.40.1.73}
